								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
									<div class="checkout-form-list">
										<label>收货人姓名 <span class="required">*</span></label> <input type="text" placeholder=""
											id="receiveName"> <span style="color: red" id="name.info"></span>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="checkout-form-list">
										<label>地址<span class="required">*</span></label> <input type="text" placeholder="具体地址"
											id="fullAddress"> <span style="color: red" id="address.info"></span>
									</div>
								</div>

								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="checkout-form-list">
										<label>电话 <span class="required">*</span></label> <input type="text" placeholder="请填写有效号码" id="phone">
