					...
					<div class="shop-left">
						...
						<div class="left-menu mb-30">
							<ul>
								...
								<%
									for (Category category2 : category.getSonCategories()) {
								%>
								<%
									num = DaoFactory.getCategoryDao().getBooksByCategoryId(category2.getId()).size();
								%>
								<li><a  ><%=category2.getName()%><span><%=num%></span></a></li>
								<%
									}
								%>
							</ul>
										...
										<div class="product-wrapper mb-40">
											<div class="product-img">
												<a> <img src="${pageContext.request.contextPath }${book.cover}" alt="book"
													class="primary" width="200" height="200"/>
												</a>
											...
											<div class="product-link">
												<div class="product-button">
													<a href="${pageContext.request.contextPath }/CartServlet?method=add&id=${book.id}"><i
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a  > <img src="img/product/3.jpg" alt="book" class="primary" />
												</a>
											</div>
										</div>
									</div>
							...
							<div class="single-shop mb-30">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a  > <img src="img/product/18.jpg" alt="book" class="primary" />
												</a>
											</div>
										</div>
									</div>
							...
							<div class="single-shop mb-30">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a  > <img src="img/product/10.jpg" alt="book" class="primary" />
												</a>
											</div>
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
										<div class="product-wrapper-content">
											...
											<div class="product-link">
												<div class="product-button">
													<a   title="Add to cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
												<div class="add-to-link">
													<ul>
														<li><a href="product-details.html" title="Details"><i
							...
							<div class="single-shop mb-30">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a  > <img src="img/product/5.jpg" alt="book" class="primary" />
												</a>
											</div>
										</div>
									</div>
							...
							<div class="single-shop">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a  > <img src="img/product/19.jpg" alt="book" class="primary" />
												</a>
											</div>
										</div>
									</div>
