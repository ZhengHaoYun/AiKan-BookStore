			...
			<ul>
				...
				<li><a class="menuFA" href="javascript:void(0)"><i class="iconfont icon-shangpin left"></i>商品管理<i
					...
					<dl>
						...
						<dt>
							<a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goods_list.jsp',this)">基本商品库</a>
						</dt>
						<dt>
					...
					<dl>
						<dt>
							<a href="javascript:void(0)"
								onclick="menuCAClick('tgls/goodsManage/goodsType_list.jsp',this)">分类列表</a>
						</dt>
